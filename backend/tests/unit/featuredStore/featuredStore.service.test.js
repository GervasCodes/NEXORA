...
jest.mock("../../../src/modules/featuredStore/featuredStore.repository");
...
const campaignRepository = require("../../../src/modules/featuredStore/featuredStore.repository");
...
const campaignService = require("../../../src/modules/featuredStore/featuredStore.service");
...
beforeEach(() => {
    ...
    settingsService.getFeaturedStoreDailyRate.mockResolvedValue(8000);
...
describe("featuredStore.service.getPricing", () => {
...
describe("featuredStore.service.createCampaign - included credits then paid", () => {
