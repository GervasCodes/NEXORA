...
export default function AdminServiceCategories() {
    ...
    // Cover image shown on the /services category cards (ServicesBrowse).
    // Optional: cards fall back to a plain label when unset, same as
    // product department cards do.
        ...
        <div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-wrap gap-3 items-start mb-8 border border-line rounded-lg p-4">
                ...
                <input
                    type="number"
                    min="0"
                    title="Display order on the /services page (lower shows first)"
                    placeholder="Order"
